...
def postChange(Map m,def issue) {
    ...
    def targetStartFormatted = cFTargetStart != 'null' ? dateTimeFormat(cFTargetStart) : ''
    def targetEndFormatted = cFTargetEnd != 'null' ? dateTimeFormat(cFTargetEnd) : ''

    def outageStartFormatted = ''
    def outageEndFormatted = ''

    if (elmOutageCF == 'Yes') {
        outageStartFormatted = elmOutageStartCF != 'null' ? dateTimeFormat(elmOutageStartCF)  : ''
        outageEndFormatted = elmOutageEndCF != 'null' ? dateTimeFormat(elmOutageEndCF)  : ''
    }
...
/********* Rest Data *******/
    ...
    def rfcData = [
        Change: [
            ...
            header                     : [
                "ChangeCoordinator"     : currentLoggedInUser,
